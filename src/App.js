...
const titles = ["Bear Cub", "Deer", "Bull", "Goat", "Donkey", "Lamb","Monkey", "Lion and Cub", "Elephants", "Giraffes", "Hippopotamus ", "Rhinoceroses"];
const pictures = [one, two, three, four, five, six, seven, eight, nine, ten, eleven, twelve];
